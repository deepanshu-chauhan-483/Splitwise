...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(signup.rejected, (s, action) => { s.loading = false; s.error = action.payload; })
      ...
      // me
      .addCase(fetchMe.fulfilled, (s, action) => { s.user = action.payload.user; })
      .addCase(fetchMe.rejected, (s, action) => { s.error = action.payload; });
  }
});
